package com.meditatenowCalmMind.api;
...
public class MNAudioManager {
	...
	public MNAudioManager() {
		addAudio(R.raw.one_introduction, (2*60 + 15)*1000 + 500, "1. Work Stress Introduction.mp3", "Settle...");
		addAudio(R.raw.two_calm_mind_instructions, (5*60 + 3)*1000 + 500, "2. Work Stress Instructions.mp3", "Focus...");
		addAudio(R.raw.three_calm_mind_lesson, (1*60 + 23)*1000 + 500, "3. Work Stress Lesson.mp3", "Breathe...");
	}
